...
gsap.from('.topview', {opacity: 0, duration: 1, delay: 1.6, y:30})
...
gsap.from('.titleone', {opacity: 0, duration: 1, delay: 1.6, y:30})
gsap.from('.book', {opacity: 0, duration: 1, delay: 1.6, y:30})
gsap.from('.aboutbc', {opacity: 0, duration: 1, delay: 1.6, y:30})
gsap.from('.contact', {opacity: 0, duration: 1, delay: 1.6, y:30})